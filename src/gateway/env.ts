...
export function buildEnvVars(env: MoltbotEnv): Record<string, string> {
  ...
  // Pass AI Gateway credentials for OpenRouter/custom gateway auth
  // These are needed by start-moltbot.sh for the OpenRouter provider config
  if (env.AI_GATEWAY_API_KEY) envVars.AI_GATEWAY_API_KEY = env.AI_GATEWAY_API_KEY;
